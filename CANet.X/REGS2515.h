...
#define CANINTF       0x2C //interrupt flag bit for each interrupt source. Pg 54.
#define EFLG            0x2D //error flag register. Pg 50.
#define TXRTSCTRL  0x0D //Configuration and control RTS pins. Pg 19.
...
// module.
#define CAN_500kbps 0x01       // BRP setting in CNF1. Pg 44.
#define CAN_250kbps 0x02       // Baud rate prescaler
